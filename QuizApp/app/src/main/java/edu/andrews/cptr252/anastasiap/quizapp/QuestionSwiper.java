...
public class QuestionSwiper extends ItemTouchHelper.SimpleCallback{
     ...
     * The touch helper attaches to the RecyclerView containing the list.
     * (based on code from:
     ...
     */
        ...
        public QuestionSwiper(QuestionAdapter adapter) {
            ...
            mBackground = new ColorDrawable(Color.LTGRAY);
        }


        /**
         * Returns true if user drags a question to another position in the list.
         * This app does not support moving questions, so the function just returns false.
